...
def main():
    ...
    feats = []
    with torch.no_grad():
        img1 = process_img('/nfs4/ajaym/Downloads/Ranked_Person_ReID-master/demo_data/1.jpg')
        feat1 = model(img1)
        feats.append(feat1)

        img2 = process_img('/nfs4/ajaym/Downloads/Ranked_Person_ReID-master/demo_data/2.jpg')
        feat2 = model(img2)
        feats.append(feat2)

        img3 = process_img('/nfs4/ajaym/Downloads/Ranked_Person_ReID-master/demo_data/3.jpg')
        feat3 = model(img3)
        feats.append(feat3)
