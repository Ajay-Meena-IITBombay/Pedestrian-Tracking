...
class opts(object):
  def __init__(self):
    ...
    #arguments of deep sort
    self.parser.add_argument("VIDEO_PATH", type=str,default="whatever")
    self.parser.add_argument("--max_dist", type=float, default=0.11)
    self.parser.add_argument("--conf_thresh", type=float, default=0.50)
    self.parser.add_argument("--nms_thresh", type=float, default=0.7)  
    self.parser.add_argument("--from_video", type=int,default=1)
    self.parser.add_argument("--external_video_path", type=str,default="unknow_video")
    self.parser.add_argument("--single_d", type=int,default=1)
    self.parser.add_argument("--only_detect", type=int,default=0)
    self.parser.add_argument("--pause_d", type=int,default=0)
    self.parser.add_argument("--yolo_cfg", type=str, default="YOLOv3/cfg/yolo_v3.cfg")
    self.parser.add_argument("--yolo_weights", type=str, default="YOLOv3/yolov3.weights")
    self.parser.add_argument("--yolo_names", type=str, default="YOLOv3/cfg/coco.names")
    #self.parser.add_argument("--conf_thresh", type=float, default=0.5)
    #self.parser.add_argument("--nms_thresh", type=float, default=0.4)
    ## this checkpoint is weights for features extraction if using different re-identificaiton model this wold get ignored
    self.parser.add_argument("--deepsort_checkpoint", type=str, default="/nfs4/ajaym/Downloads/cendeep_sort_pytorch-master/_parameters/ckpt.t7")
    self.parser.add_argument("--display", type=int,default=1)
    self.parser.add_argument("--display_width", type=int, default=800)
    self.parser.add_argument("--display_height", type=int, default=600)
    self.parser.add_argument("--save_path", type=str, default="demo.avi")
